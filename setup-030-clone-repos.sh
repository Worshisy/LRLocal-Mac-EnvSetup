#!/usr/bin/env bash
# setup-030-clone-repos.sh — clone the 4 private project repos into a workspace dir.
#
...
#
# Usage:
#   ./setup-030-clone-repos.sh                 # clone into the PARENT dir of this kit (../)
#   ./setup-030-clone-repos.sh /path/to/dir    # clone into a chosen dir
#   WITH_SUBMODULES=0 ./setup-030-clone-repos.sh   # SKIP USRP's uhd+gnuradio source (default: pull it)
set -u
