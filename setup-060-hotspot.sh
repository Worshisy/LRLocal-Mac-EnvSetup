...
# and makes run.sh stop to ask. Disable it on the capture volume(s). field-000-jobs.sh
...
[ "$_sl_found" = 1 ] || warn "no capture SSD mounted now — field-000-jobs.sh also disables it at RX start"
